...
Original file is located at
    https://colab.research.google.com/drive/1QgcsafVJTkGrrHmZ0opvVd9REkD22Xp0
"""
...
csv_file_path = '/content/kidney_disease.csv'
...
data_training = pd.DataFrame(data['texture_mean'][0:int(len(data)*0.70)])
data_testing = pd.DataFrame(data['texture_mean'][int(len(data)*0.70): int(len(data))])
